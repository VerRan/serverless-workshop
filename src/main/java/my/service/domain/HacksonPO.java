...
@DynamoDBTable(tableName = "HacksonTable")
public class HacksonPO {
    ...
    @DynamoDBAttribute(attributeName = "hacksonCreateDate")
    private String  hacksonCreateDate;

    @DynamoDBAttribute(attributeName = "hacksonExpireDate")
    private String  hacksonExpireDate;

    @DynamoDBAttribute(attributeName = "hacksonStartTime")
    private String  hacksonStartTime;

    @DynamoDBAttribute(attributeName = "hacksonEndTime")
    private String hacksonEndTime;

    @DynamoDBAttribute(attributeName = "hacksonState")
    private String         hacksonState;

    @DynamoDBAttribute(attributeName = "hacksonName")
